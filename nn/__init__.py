...
#            data[i] = np.array( data[i], dtype=np.float32 )
        ...
        # NN学習
        message = nn.train( data, x, y, m_, graph, loss, train_step, index, self.__itr1, self.__itr2, self.get_name(), self.__batch_size1, self.__batch_size2, self.seaquence_size, self.__mode )
